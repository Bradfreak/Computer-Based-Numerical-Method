/* This program finds the definite integral of x(1-x^2) with lower limit as a and upper limit as b using simpsons method.
Take input as h.
...
double function(double x)
{
  ...
  f = x - (x*x*x); /* Finding the function value */
