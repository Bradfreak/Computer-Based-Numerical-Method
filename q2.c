/* This program finds the definite integral of 1/(1+x^3) with lower limit as a and upper limit as b using simpsons method.
Take input as h.
...
double function(double x)
{
  ...
  f = 1/(1+x*x*x); /* Finding the function value */
